...
const Submit: FC = (): ReactElement => {
  return (
    <div className="submit">
        ...
        <p className="submit-content">We are ready to work on a project of any complexity, 
            <br></br>
        ...
        <Form className="form">
            <Row>
                <Col span = {5}>
                    <Input type="text" className="input-name input" placeholder="Your Name"/>
                </Col>
                <Col span = {5}>
            ...
            <Row>
                <Col span = {5}>
                    <Input type="text" className="input-Reason input" placeholder="Reason for Contacting*"/>
                </Col>
                <Col span = {5}>
            ...
            <Row >
                <Col span = {12}>
                    <TextArea rows={4}  className="input-Message" placeholder="Message" />
                </Col>
            </Row>
        </Form>
